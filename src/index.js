...
client.on("messageCreate", message => {
    ...
    if (message.content.includes("Nils")) message.reply("N-nils sama ! arrêtez de courir nu dans votre chambre !");
    ...
    if (message.content == "Ban") message.reply("Onegai Goshujin-sama, réfléchissez-y vraiment avant de le faire cette fois-ci...");
